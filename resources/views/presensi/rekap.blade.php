                            ...
                            <form action="/presensi/cetakrekap" target="_blank" method="POST">
                                    ...
                                    <div class="row mt-1">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <select name="kode_cabang" id="kode_cabang" class="form-select" hidden>
                                ...
                                @role('administrator', 'user')
                                    <div class="row mt-2">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <select name="kode_dept" id="kode_dept" class="form-select" hidden>
                                ...
                                <div class="row mt-2">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <select name="jenis_laporan" id="jenis_laporan" class="form-select" hidden>
                                                <option value="1">Jenis Laporan</option>
