    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('presensi/realisasi') ? 'active' : '' }}"
                        href="/presensi/realisasi">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <!-- Download SVG icon from http://tabler-icons.io/i/home -->
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="icon icon-tabler icon-tabler-heart-rate-monitor" width="24" height="24"
                ...
                <li class="nav-item dropdown">
                    ...
                    <div
                        class="dropdown-menu {{ request()->is(['presensi/laporan', 'presensi/rekap', 'presensi/laporanpenerimaan', 'presensi/rekappenerimaan']) ? 'show' : '' }}">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                ...
                                <a class="dropdown-item {{ request()->is(['presensi/laporanpenerimaan']) ? 'active' : '' }}"
                                    href="/presensi/laporanpenerimaan">
                                    Penerimaan
                                </a>
                                <a class="dropdown-item {{ request()->is(['presensi/rekappenerimaan']) ? 'active' : '' }}"
                                    href="/presensi/rekappenerimaan">
                                    Realisasi Penerimaan
                                </a>
                            </div>
                        </div>
