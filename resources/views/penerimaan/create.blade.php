...
<div class="appHeader bg-primary text-light">
    ...
    <div class="pageTitle">Form Penerimaan</div>
    <div class="right"></div>
</div>
<!-- * App Header -->
@endsection
...
<div class="row" style="margin-top:70px">
    <div class="col">
        ...
        <!--<div class="form-group">
            ...
            <div class="form-group">
                <input type="text" id="notice_keluar" name="notice_keluar" class="form-control" autocomplete="off" placeholder="Notice Keluar">
            </div>
            <div class="form-group">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#tgl_penerimaan,#tgl_izin_sampai").change(function(e) {
            loadjumlahhari();
        });
